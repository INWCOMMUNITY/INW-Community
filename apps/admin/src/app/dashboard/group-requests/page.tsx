...
export default function GroupCreationRequestsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-2">Group creation requests</h1>
      <p className="text-gray-600 mb-6">
        Approve to create the group and make the requester a group admin. Deny to reject and email them your explanation
