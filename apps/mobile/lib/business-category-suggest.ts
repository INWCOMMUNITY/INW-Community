/** Mirrors apps/main/src/lib/business-category-suggest.ts (keep in sync). */

export type CategoryPreset = { label: string; subcategories: string[] };
