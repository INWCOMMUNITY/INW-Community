...
export default function ResaleHubPickupsScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.intro}>
        Resale orders with pickup will appear here. Mark them as picked up when the buyer collects the item.
      </Text>
      <FlatList
        data={orders}
        keyExtractor={(o) => o.id}
        ...
        renderItem={({ item }) => (
          <Pressable
            ...
            onPress={() =>
              router.push(
                `/web?url=${encodeURIComponent(`${siteBase}/resale-hub/pickups`)}&title=${encodeURIComponent("My Pickups")}` as never
              )
            }
          >
