...
const SPONSOR_BENEFITS = [
  ...
  { title: "Offer Coupons", description: "Add coupons to the NWC coupon book. Subscribers can redeem your discounts, driving traffic and loyalty to your business.", imageSrc: cloudinaryFetchUrl(WIX_IMG(SPONSOR_INFO_BENEFIT_IMAGES[1])), imageAlt: "NWC coupons" },
  { title: "Post Events on Our Calendars", description: "Promote your events across our six community calendars: Fun Events, Local Art & Music, Non-Profit, Business Promo, Marketing, and Real Estate.", imageSrc: cloudinaryFetchUrl(WIX_IMG(SPONSOR_INFO_BENEFIT_IMAGES[2])), imageAlt: "Event calendars" },
  { title: "Offer Rewards to the Community", description: "We as locally owned companies in Eastern Washington and North Idaho, want to team up and create incentives for residents in this area to support local vs corporate. Residents gain points for supporting local, and they can redeem points for rewards offered by NWC and Local Businesses in our area.", imageSrc: cloudinaryFetchUrl(WIX_IMG(SPONSOR_INFO_BENEFIT_IMAGES[3])), imageAlt: "NWC community events" },
