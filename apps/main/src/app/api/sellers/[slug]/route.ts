  ...
  try {
    ...
    return NextResponse.json({
      ...
      member: {
        ...
        firstName: business.member.firstName,
      ...
      acceptReturnsDays: business.member.acceptReturnsDays ?? 30,
      chargeReturnShipping: business.member.chargeReturnShipping === true,
