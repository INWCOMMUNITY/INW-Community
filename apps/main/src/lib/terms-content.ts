...
Sellers may optionally connect a third-party marketplace account (such as Etsy, eBay, Wix, and Shopify) to sync listings with their NWC storefront. If you connect a marketplace, you authorize NWC to access that account on your behalf to create, update, and remove listings, read your listings and orders/receipts, and adjust inventory quantities. Inventory is pooled across connected stores: a sale on any connected store reduces the shared available quantity, and NWC will attempt to update the other connected stores accordingly. Syncing depends on the third party's APIs and may be delayed, incomplete, or temporarily unavailable; in rare cases an item may sell on more than one store before quantities update. NWC is not responsible for oversells, listing rejections, fees, account suspensions, or other issues arising from a connected marketplace or its policies. You remain responsible for complying with each marketplace's rules.

You may disconnect a marketplace at any time from Seller Hub. When disconnecting, you may choose to keep linked listings on INW Community (sync stops; listings generally remain on the third-party store) or delete those linked listings from INW Community only (NWC does not remove listings on the third-party store when you choose delete from INW). Disconnecting stops all future syncing between NWC and that marketplace.
