...
/** Fields needed to validate an accepted-offer line (partial Prisma include is OK). */
export type ResaleOfferForCartPrice = Pick<
  ResaleOffer,
  "id" | "buyerId" | "status" | "checkoutDeadlineAt" | "finalAmountCents"
>;

export type CartRowForOfferPrice = Pick<CartItem, "priceOverrideCents" | "resaleOfferId"> & {
  resaleOffer: ResaleOfferForCartPrice | null;
};
...
export function resolvedPriceForCartLine(
  ...
  cartRow: CartRowForOfferPrice | undefined,
  buyerId: string
