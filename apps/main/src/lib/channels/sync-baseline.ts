 ...
 * Sized to cover the provider's write-visibility lag (webhooks/refresh can fire within seconds of a
 * push) without masking a genuine remote edit that lands later.
 */
