...
export const SITE_IMAGE_KEYS = [
  ...
  { key: "founder-thanks", path: "/founder-thanks.png", label: "Home – Founder thank-you photo" },
  ...
  { key: "community-goals", path: "/community-goals.png", label: "Home – Community Goals photo" },
